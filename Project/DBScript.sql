...
AS SELECT c.Id, c.ProjectId, c.Title, c.Description, c.Status, c.DueDate, a.FirstName as AssigneeFirstName, a.LastName as AssigneeLastName, b.FirstName as ReporterFirstName, b.LastName as ReporterLastName
